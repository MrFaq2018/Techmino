return {
    ...
    infHeightOn="Altura Infinita ON",
    infHeightOff="Altura Infinita OFF",
    infHeightHint="Se activa con Función1",
    highestGrade="(Récord: $1)",
    ...
    ai_puzzle="La IA no es compatible con el modo Puzzle",
    ...
    cc_solid="CC no es compatible con líneas llenas en el tablero.",
    cc_field_too_high="CC no es compatible con matrices de más de 40 líneas.",
    ...
    invalidSequence="Modo de secuencia inválido",
    tooHighField="Data del tablero que excede 126 líneas se descarta",
    ...
    WidgetText={
        ...
        net_galaxim={
            match="Iniciar Sim.", -- (Actively) Enter (the) (digital) Simulation of (a galaxy)
        },
        net_rooms={
            password="Contraseña",
        ...
        setting_video={
            ...
            bg_custom_base64="Pega la imagen en formato BG\n(PNG/JPG en Base64)",
            defaultBG="Fondo por defecto",
            resetDbg="Restaurar",
            lockBG="Fijar Fondo",
            noTheme="Deshab. Tema",
    ...
    modes={
        ...
        ['construct_checker']=   {"Construcción",       "INTERCALADO",   "¡Arma intercalando huecos y bloques!"},
        ['construct_invsg']=     {"Construcción",       "SG INVERT.",    "¡¡Arma poniendo bloques en escalera!!"},
        ...
        ['big_n']=          {"Big",                     "Normal",        "¡El tablero es más pequeño!"},
        ['big_h']=          {"Big",                     "Difícil",       "¡El tablero es más pequeño!"},
        ...
        ['blind_e']=        {"A Ciegas",                "LENTO",         "Para principiantes."},
        ['blind_n']=        {"A Ciegas",                "RÁPIDO",        "Para jugadores intermedios."},
        ['blind_h']=        {"A Ciegas",                "INSTANTÁNEO",   "Para jugadores experimentados."},
        ['blind_l']=        {"A Ciegas",                "SIN FANTASMA",  "Para profesionales."},
        ['blind_u']=        {"A Ciegas",                "SIN TABLERO?",  "¿Estás preparado?"},
        ['blind_wtf']=      {"A Ciegas",                "VACÍO 8)",      "No, no lo estás."},
        ...
        ['tech_finesse_f']= {"Tech",                    "PLUS",          "Sin errores de finesse,\n¡pero tampoco clears normales!"},
        ...
        ['spinren']=        {"Combos All-Spin",         "EFICIENCIA",    "Un Spike de la nada."},
